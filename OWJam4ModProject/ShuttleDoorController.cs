...
namespace OWJam4ModProject
{
    internal class ShuttleDoorController : MonoBehaviour
    {
        ...
        {
            OWJam4ModProject.Log("Started closing doors", OWML.Common.MessageType.Success);
            ...
            OWJam4ModProject.Log("Finished closing doors", OWML.Common.MessageType.Success);
        }

        IEnumerator OpenDoors()
        {
            OWJam4ModProject.Log("Started opening doors", OWML.Common.MessageType.Success);
            ...
            OWJam4ModProject.Log("Finished opening doors", OWML.Common.MessageType.Success);
        }
    }
}
